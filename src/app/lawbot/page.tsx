      ...
      <main className="flex-1 p-4 lg:p-6 flex justify-center items-start">
        <Card className="w-full max-w-4xl h-full flex flex-col bg-card">
          ...
          <CardContent className="flex-1 flex flex-col overflow-hidden p-0">
            <ScrollArea className="flex-1 px-6 bg-background" viewportRef={viewportRef}>
                  ...
                  <div key={message.id} className={`flex items-start gap-3 ${message.sender === 'user' ? 'justify-end' : ''}`}>
                    ...
                    <div 
                      className={cn(
                        ...
                        message.sender === 'user' ? 'bg-primary text-primary-foreground' : 'bg-muted text-foreground border border-border',
